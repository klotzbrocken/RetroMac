...
RetroMac is distributed as a notarized macOS app. Only the latest released
...
Preferred: use GitHub's private vulnerability reporting via the **Security** tab
...
- **Status update:** within 10 business days, including whether the report is
  accepted and an expected timeline for a fix.
- **Disclosure:** once a fix is released, we are happy to credit you in the
